...
export class ToolExecutor {
    ...
    searchFiles(rootRel: string, globalPattern: string, contentQuery?: string): string {
        ...
        const nameRe = regexFromGlob(globalPattern.replace(/\\/g, "/"));
